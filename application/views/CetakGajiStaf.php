                    ...
                    <div class="ibox-content p-xl">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    ...
                                    <span>To:</span>
                                    <address>
                                        <strong><?= $detail['nama_staf'] ?></strong><br>
                                        <?= $detail['alamat'] ?><br>
                                        <br>
                                        <abbr title="NIP"><i class="fa fa-drivers-license">: </i></abbr> <?= $detail['nip'] ?>
                                    </address>
                                    <p>
                            ...
                            <table class="table invoice-total">
                                ...
                                <tr>
                                    ...
                                    <td><?= $detail['tunjangan'] * $detail['jammasuk'] ?></td>
                                </tr>
                                <tr>
