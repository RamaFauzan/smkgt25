                    ...
                    <div class="ibox-content p-xl">
                            ...
                            <div class="table-responsive m-t">
                                <table class="table invoice-table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><div><strong>Uang Bangunan</strong></div></td>
                                        
                                        
                                        
                                        <td><?= $detail['uang_bangunan'] ?></td>
                                    </tr>
                                    <tr>
                                        <td><div><strong>Uang SPP</strong></div></td>
                                        
                                        
                                      
                                        <td><?= $detail['sisa_pembayaran_spp'] ?></td>
                                    </tr>
                                    <tr>
                                        <td><div><strong>Uang Kaos Olahraga</strong></div></td>
                                    ...
                                    <tr>
                                        <td><div><strong>Uang Batik</strong></div></td>
                                     ...
                                     <tr>
                                        <td><div><strong>Uang UTS</strong></div></td>
                                     ...
                                     <tr>
                                        <td><div><strong>Uang Almamater</strong></div></td>
                            ...
                            <table class="table invoice-total">
                                ...
                                <tr>
                                    ...
                                    <td>Rp.<?php echo number_format($detail['uang_bangunan'] + $detail['sisa_pembayaran_spp']) ?></td>
                                </tr>
                                </tbody>
                            </table>
