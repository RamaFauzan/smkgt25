                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form action="<?php echo site_url('Welcome/AddDataStafBawah'); ?>" enctype="multipart/form-data" method="post">
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">NO INDUK PEGAWAI</label>

                                    <div class="col-sm-10">
                                    
                               		<input type="text" name="nip" value="" class="form-control"></div>
                                </div>
								      
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">NAMA STAF</label>
                                    <div class="col-sm-10"><input type="text" name="nama_staf" class="form-control" value=""></div>
                                </div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">ALAMAT</label>
                                    <div class="col-sm-10"><input type="text" name="alamat" class="form-control" value=""></div>
                                </div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">UPLOAD FOTO</label>
                                    <div class="col-sm-10"><input type="file" name="foto_staf" class="form-control" value=""></div>
                                </div>
