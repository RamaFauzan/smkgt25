            ...
            <br>
                    ...
                    <?php
                    $i=1;
                    if(!empty($DataPenggajianStaf))
                    {
                      foreach($DataPenggajianStaf as $ReadDS)
                      {
                    ?>
               <tr>
                    ...
                    <td>
                   <a href="<?php echo site_url('Welcome/DataPenggajianStaf/'.$ReadDS->nip.'/view') ?>"><i class="fa fa-id-card"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <!-- <a href="<?php echo site_url('Welcome/DeleteDataSiswa/'.$ReadDS->nip) ?>"><i class="fa fa-trash-o"></i></a>
                    </td> -->
              </tr>
                    <?php } } ?>
                   </tbody>
