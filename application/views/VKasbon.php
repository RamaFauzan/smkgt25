               ...
               <table class="table table-striped table-bordered table-hover dataTables-example" >
				...
				?>
					...
					<tr>
						...
						<?php if($akses == '1'): ?>
						<td>
							<a class="btn bg-warning" data-toggle="modal" data-target="#myModal5<?php echo $ReadDS->kd_kasbon_guru; ?>"><i class="fa fa-pencil"></i></a>
					...
					<div class="modal modal-danger fade" id="delete<?php echo $i; ?>">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a href="<?php echo site_url('Welcome/DeletePengumuman/'.$ReadDS->kd_kasbon_guru); ?>" class="btn btn-outline">Hapus Data</a>
								</div>
							</div>
						</div>
					</div>
					  ...
					  <div class="modal inmodal" id="myModal5<?php echo $ReadDS->kd_kasbon_guru; ?>" tabindex="-1" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog">
												...
												<form action="<?php echo site_url('Welcome/UpdateKasbon'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
												              <div class="box-body">
												                <!-- <div class="form-group">
												                  ...
												                  <div class="col-sm-10">
												                    <input type="text" name="kd_kasbon_guru" value="<?php echo $ReadDS->kd_kasbon_guru; ?>" class="form-control" id="inputEmail3" placeholder="Kodes">
												                  </div>
												                </div> -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        ...
                                        <div class="modal-body">
											...
											<form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('Welcome/AddDataKasbon'); ?>" method="post">
											                ...
											                <div class="form-group">
											                  <label class="col-sm-2 control-label">Isi kasbon</label>
