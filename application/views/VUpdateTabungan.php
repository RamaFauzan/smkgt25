	<form action="<?php echo site_url('Welcome/AddDataTabungan'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
												              <div class="box-body">
												                ...
												                <!-- <input type="hidden" name="kd_pendapatan" value="<?= $detail['kd_pendapatan']; ?>"> -->
	...
	function Hitung() {
        ...
        var hasil2 = txt2value * 10/100;

        if (!isNaN(hasil)) {
            document.getElementById('totals').value = hasil - hasil2;
            document.getElementById('totals2').value = hasil2;
        }
    }
 </script>
